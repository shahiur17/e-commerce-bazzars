...
const WatchProductCarts = () => {
    const getSafeData = (array) => Array.isArray(array) ? array : [];
    const topWatch = getSafeData(data?.watches).slice(0, 10);

    return (
        <div>
             <section>
                <h2 className="text-2xl text-center font-bold my-4">Top Shoes watches</h2>
...
export default WatchProductCarts;